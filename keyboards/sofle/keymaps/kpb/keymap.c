...
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,   RGB_TOG, KC_N,     KC_M,     KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, \
                 KC_LGUI,KC_LALT,KC_LCTRL, KC_LOWER, KC_QUOT,   KC_SPC,  KC_RAISE, KC_RCTRL, KC_RALT, KC_RGUI \
),
...
[_ADJUST] = LAYOUT( \
  ...
  RGB_MOD,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                       XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX, \
